...
function Profil() {
  ...
  const dodajSlikuKorisniku = () => {
    ...
    const url = `http://localhost:5153/Korisnik/DodajSlikuKorisniku?id_korisnika=${korisnikId}`;
  ...
  const ucitajDogadjaje = () => {
    ...
    const url = `http://localhost:5153/Korisnik/VratiDogadjajeKorisnika/${korisnik_Id}/${brojPosiljke}/${ukupnoElemenata}`;
    fetch(url, {
      method: 'GET',
      credentials: 'include',
    })
  ...
  const handleDeleteImage = () => {
    const korisnik_Id = Cookies.get('userID');
    const url = `http://localhost:5153/Korisnik/IzbrisiSlikuKorisnika/${korisnik_Id}`;
                            ...
                            {korisnik ? (
                              <div className="image-wrapper">
                                <img
                                    ...
                                    src={korisnik.korisnikImage ? `http://localhost:5153/resources/${korisnik.korisnikImage}` : "http://via.placeholder.com/170x170"}
                                  />
                              ...
                              <div className="post-bar">
                                <div className="post_topbar">
                                  ...
                                  {korisnik ? <img
                                    ...
                                    src={korisnik.korisnikImage ? `http://localhost:5153/resources/${korisnik.korisnikImage}` : "http://via.placeholder.com/50x50"}/> : <p>Korisnik nije dostupan</p>}
                                ...
                                <div className="job_descp">
                                  ...
                                  {/* https://localhost:5153/resources/${dogadjaj.dogadjajImage} */}
                                  {/* MAPA POCETAK */}
                                  <HideShowMapa
                                    latitude={dogadjaj.x}
